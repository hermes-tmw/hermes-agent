...
DEFAULT_CONFIG = {
    ...
    "voice": {
        ...
        "vad": {
            "provider": "rms",        # "silero" | "rms" (backward compat, default rms)
            "silero": {
                "threshold": 0.5,     # Speech probability threshold (0.0-1.0)
                "min_speech_ms": 300,   # Min speech duration before confirming utterance
                "min_silence_ms": 700,  # Min silence after speech to trigger endpoint
                "model_path": "",      # Optional; defaults to ~/.hermes/cache/silero-vad/silero_vad.onnx
            },
            "rms": {
                "threshold": 200,     # RMS below this = silence (0-32767)
                "silence_duration": 3.0,  # Seconds of silence before auto-stop
            },
        },

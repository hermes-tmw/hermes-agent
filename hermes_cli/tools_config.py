...
CONFIGURABLE_TOOLSETS = [
    ...
    ("mattermost_history", "💬 Mattermost History",    "fetch channel history on request"),
...
_DEFAULT_OFF_TOOLSETS = {"homeassistant", "spotify", "discord", "discord_admin", "mattermost_history", "video", "video_gen", "x_search", "a2a"}
